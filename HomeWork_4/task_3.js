...
var gain = [1000, 3000, 5000, 'первая несгораемая сумма 10000', 20000, 60000, 80000,
    'вторая несгораемая сумма 100000', 500000, 1000000];

var answers = [['A: попало в лоб B: залетело в рот C: накапало в уши  D: бросилось в глаза '], ['A: путепровод B: путеукладчик C: путеводитель D:путеводная звезда  '], ['A: Испания B: Италия C: Венгрия D: Греция'],
...
var correct = ['D', 'C', 'B', 'A', 'B', 'C', 'B', 'D', 'A', 'D'];
